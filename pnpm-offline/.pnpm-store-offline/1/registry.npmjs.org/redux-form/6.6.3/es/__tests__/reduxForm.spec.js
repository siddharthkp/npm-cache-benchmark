  ...
  describe(name, function () {
    ...
    it('should no resubmit if async submit is in progress', function () {
      ...
      var submitSpy = createSpy().andCall(function () {
        return new Promise(function () {/* Promise will never resolve */
        });
      });
    ...
    it('should allow sync validation for array props on push', function () {
      ...
      var renderArray = function renderArray(_ref4) {
    ...
    it('should not reinitialize values on remount if destroyOnMount is false', function () {
      ...
      var Container = function (_Component41) {
        _inherits(Container, _Component41);

        function Container() {
          _classCallCheck(this, Container);

          var _this52 = _possibleConstructorReturn(this, (Container.__proto__ || Object.getPrototypeOf(Container)).call(this));

          _this52.state = { showForm: true };
          return _this52;
        }
          ...
          value: function render() {
            ...
            return React.createElement(
              ...
              React.createElement(
                'button',
                { onClick: function onClick() {
                    return _this53.setState({ showForm: !showForm });
                  } },
                'Toggle Form'
              )
            );
